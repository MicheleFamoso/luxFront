const FooterLux = () => {
  return (
    <div>
      <div
        className="
         mt-10 md:mt-12  md:m-auto static  md:w-11/12 "
      >
        <hr className=" mx-2 md:mx-0 mb-2 md:mb-6 text-gray-light" />
        <div
          className="grid grid-cols-1 md:grid-cols-4 px-2 md:px-0 md:p-0 mb-8 md:gap-70
        "
        >
          <div>
          ...
          <div>
            ...
            <a
              className="font-kosugi  text-gray-bold text-xl"
