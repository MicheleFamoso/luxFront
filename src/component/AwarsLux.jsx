...
const AwardsLux = () => {
  ...
  return (
    <div className=" mt-2 md:mt-6 md:w-8/12 md:m-auto static">
      <h1 className="text-2xl md:text-3xl font-bold font-kosugi px-6 md:px-0   text-gray-medium mb-12 ">
        Awards/Show
      </h1>
      {isLoading ? (
        <Loading />
            ...
            <div key={mostra.id} className=" my-8">
              <div className="grid grid-cols-1 md:grid-cols-3 md:gap-6 mb-8 gap-0 px-6 md:px-0">
                ...
                <div className="md:col-span-2 font-kosugi">
                  <p className="md:text-2xl text-xl font-semibold  text-gray-medium ">
                    {mostra.descrizione}
                  </p>
